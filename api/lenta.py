...
class LentaNewsParser:
    ...
    def __init__(self, base_url: str = 'https://lenta.ru/'):
        """
        ...
        self.url_helper = 'https://lenta.ru'
        ...
        self.serious = ["/rubrics/world/", "/rubrics/economics/", '/rubrics/sport/', '/rubrics/science/', "/rubrics/culture/"
                        ]
    ...
    def get_main_page_links(self) -> List[str]:
        ...
        try:
            ...
            allfd = soup.find_all('li', class_="menu__nav-item")
            ...
            for href in allfd:
                ...
                if link_element:
                    ...
                    if (link_element['href'] == "/rubrics/world/"):
                        self.categ[link_element['href']] = "Политика"
                    elif (link_element['href'] == '/rubrics/science/'):
    ...
    def _parse_article_page(self, url: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            title_elem = soup.find_all('h1', class_="topic-body__titles")
            for element in title_elem:
                title += element.get_text()
            # Извлечение даты публикации
            date_elem = soup.find_all('a', class_="topic-header__item topic-header__time")
            for element in date_elem:
                publish_date += element.get_text()
            # Извлечение содержимого статьи
            content_elem = soup.find_all('p', class_="topic-body__content-text")
        ...
        for link in category_links:
            ...
            try:
                ...
                if link in self.serious:
                    news_blocks = soup.find_all('div', class_='rubric-page__container')
                else:
                    continue
    ...
    def save_to_json(self, news_items: List[NewsItem], filename: str = 'lenta_news.json'):
    ...
    def run_full_parsing_Lenta(self, output_file: str = 'lenta_news.json') -> List[NewsItem]:
        """
